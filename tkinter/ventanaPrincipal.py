...
from importarArchivo import seleccionarArchivo

# raiz
root = tk.Tk()
# titulo
root.title("Gestor de inventarios")
#********* confogurcion de tamaño de ventana *********** 
...
file.add_command(label="Centros logísticos", command=seleccionarArchivo)
menubar.add_cascade(label="Actualizar datos", menu=file)
